var Student = function(studentName, phone = "", email = "") {
  ...
  this.addToTable = function(table) {
    ...
    cell.innerHTML = this.name + '<p>12345 SW Main Street<br>Portland, OR 97123</p>';
...
function initializePage() {
  ...
  if (storedStudents != null) {
    students = [];
    for (var index = 0; index < storedStudents.length; index++) {
      var student = storedStudents[index];
      students.push(new Student(student.name, student.phone, student.email));
    }
  }
}
